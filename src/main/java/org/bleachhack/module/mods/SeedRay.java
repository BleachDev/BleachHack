...
public class SeedRay extends Module {
    ...
    public void onEnable(boolean inWorld) {
        ...
        if (worldSeed == null) {
            BleachLogger.info("Please input a seed using " + Option.CHAT_COMMAND_PREFIX.getValue() + "seedray <seed>");
    ...
    public void doMathOnChunk(int chunkX, int chunkZ) {
        ...
        if (id == null) {
            BleachLogger.info("Unable to calculate ore positions, there may be mods affecting world generation");
            this.setEnabled(false);
            return;
        }
