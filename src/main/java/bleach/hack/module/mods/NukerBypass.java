		...
		switch (EntityUtils.GetFacing()) {
			case East:
				for (int i = 0; i < 1; ++i) {
					...
					cubeBlocks.add(playerPos.east().south().south().up());
					cubeBlocks.add(playerPos.east().south().south().up().up());
					cubeBlocks.add(playerPos.east().south().south().up().up().up());
					cubeBlocks.add(playerPos.east().north());
					cubeBlocks.add(playerPos.east().north().up());
					cubeBlocks.add(playerPos.east().north().up().up());
					cubeBlocks.add(playerPos.east().north().up().up().up());
					cubeBlocks.add(playerPos.east().north().north());
					...
					cubeBlocks.add(playerPos.east().north().north().north().up());
					cubeBlocks.add(playerPos.east().north().north().north().up().up());
					cubeBlocks.add(playerPos.east().north().north().north().up().up().up());
					playerPos = new BlockPos(playerPos).east();
				}
				break;
			case North:
				for (int i = 0; i < 1; ++i) {
					...
					cubeBlocks.add(playerPos.north().east().up().up());
					cubeBlocks.add(playerPos.north().east().up().up());
					cubeBlocks.add(playerPos.north().east().east().up());
					cubeBlocks.add(playerPos.north().east().east().up().up());
					cubeBlocks.add(playerPos.north().east().east().up().up().up());
					cubeBlocks.add(playerPos.north().west());
					cubeBlocks.add(playerPos.north().west().up());
					cubeBlocks.add(playerPos.north().west().up().up());
					cubeBlocks.add(playerPos.north().west().up().up().up());
					cubeBlocks.add(playerPos.north().west().west());
					cubeBlocks.add(playerPos.north().west().west().up());
					cubeBlocks.add(playerPos.north().west().west().up().up());
					cubeBlocks.add(playerPos.north().west().west().up().up().up());
					cubeBlocks.add(playerPos.north().west().west().west().up());
					cubeBlocks.add(playerPos.north().west().west().west().up().up());
					cubeBlocks.add(playerPos.north().west().west().west().up().up().up());
					playerPos = new BlockPos(playerPos).north();
				}
				break;
			case South:
				for (int i = 0; i < 1; ++i) {
					...
					cubeBlocks.add(playerPos.south().east().east());
					cubeBlocks.add(playerPos.south().east().east().up());
					cubeBlocks.add(playerPos.south().east().east().up().up());
					cubeBlocks.add(playerPos.south().east().east().up().up().up());
					cubeBlocks.add(playerPos.south().east().east().east().up());
					cubeBlocks.add(playerPos.south().east().east().east().up().up());
					cubeBlocks.add(playerPos.south().east().east().east().up().up().up());
					playerPos = new BlockPos(playerPos).south();
				}
				break;
			case West:
				for (int i = 0; i < 1; ++i) {
					...
					cubeBlocks.add(playerPos.west().north().north().up());
					cubeBlocks.add(playerPos.west().north().north().up().up());
					cubeBlocks.add(playerPos.west().north().north().up().up().up());
					cubeBlocks.add(playerPos.west().south());
					cubeBlocks.add(playerPos.west().south().up());
					cubeBlocks.add(playerPos.west().south().up().up());
					cubeBlocks.add(playerPos.west().south().up().up().up());
					cubeBlocks.add(playerPos.west().south().south());
