...
//TODO FIGURE OUT WHAT STUFF NEEDS TO BE UPDATED HERE TO WORK
//import java.util.*;
//
...
//
//                                    ++count;
//                                    Vec3d pos = new Vec3d((Double) Objects.requireNonNull(RenderUtils.getField(Particle.class, "posX", "posX")).get(p), (Double) Objects.requireNonNull(ReflectUtils.getField(Particle.class, "posY", "posY")).get(p), (Double) Objects.requireNonNull(ReflectUtils.getField(Particle.class, "posZ", "posZ")).get(p));
//
