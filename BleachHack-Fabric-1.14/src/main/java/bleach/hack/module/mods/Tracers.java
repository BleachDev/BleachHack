...
public class Tracers extends Module {
	...
	public Tracers() {
		super("Tracers", KEY_UNBOUND, Category.RENDER, "Shows lines to entities you select.",
				...
				new SettingToggle("Mobs", false).withDesc("Show Mob Tracers")
						.withChildren(new SettingColor("Color", 0.5f, 0.1f, 0.5f, false).withDesc("Tracer color for mobs")),
				new SettingToggle("Animals", false).withDesc("Show Animal Tracers")
						.withChildren(new SettingColor("Color", 0.3f, 1f, 0.3f, false).withDesc("Tracer color for animals")),
				new SettingToggle("Items", true).withDesc("Show Item Tracers")
						.withChildren(new SettingColor("Color", 1f, 0.8f, 0.2f, false).withDesc("Tracer color for items")),
				new SettingToggle("Crystals", true).withDesc("Show End Crystal Tracers")
						.withChildren(new SettingColor("Color", 1f, 0.2f, 1f, false).withDesc("Tracer color for crystals")),
				new SettingToggle("Vehicles", false).withDesc("Show Vehicle Tracers")
						.withChildren(new SettingColor("Color", 0.6f, 0.6f, 0.6f, false).withDesc("Tracer color for vehicles (minecarts/boats)")),
	...
	public void onRender(EventWorldRender event) {
		...
		for (Entity e : mc.world.getEntities()) {
			...
			Vec3d vec2 = new Vec3d(0, 0, 75).rotateX(-(float) Math.toRadians(mc.cameraEntity.pitch)).rotateY(-(float) Math.toRadians(mc.cameraEntity.yaw))
