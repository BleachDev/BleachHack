...
public class PacketFly extends Module {
	...
	public void onTick(EventTick eventTick) {
		...
		if(getSettings().get(0).toMode().mode == 0) {
			...
			//mc.player.networkHandler.sendPacket(new PlayerMoveC2SPacket.PositionOnly(mc.player.x+1.5, mc.player.y, mc.player.z, false));
			//mc.player.networkHandler.sendPacket(new PlayerMoveC2SPacket.PositionOnly(mc.player.x, mc.player.y - 0.1, mc.player.z, true));
