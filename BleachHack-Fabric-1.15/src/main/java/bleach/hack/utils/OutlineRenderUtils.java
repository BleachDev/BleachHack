...
public class OutlineRenderUtils {
	...
	public static void renderPass(Entity entity, MatrixStack matrices, float r, float b, float g, float a) {
		...
		mc.getEntityRenderManager().getRenderer(entity).render(entity, yaw, mc.getTickDelta(), matrices, outlineVertexConsumerProvider, 0xF000F0);
		immediate.draw(RenderLayer.getEntitySolid(mc.getEntityRenderManager().getRenderer(entity).getTexture(entity)));
		immediate.draw(RenderLayer.getEntityCutout(mc.getEntityRenderManager().getRenderer(entity).getTexture(entity)));
		immediate.draw(RenderLayer.getEntityCutoutNoCull(mc.getEntityRenderManager().getRenderer(entity).getTexture(entity)));
		immediate.draw(RenderLayer.getEntitySmoothCutout(mc.getEntityRenderManager().getRenderer(entity).getTexture(entity)));
		immediate.draw();
