...
public class CmdGive extends Command {
	...
	public String getSyntax() {
		return "give [item] [count] [damage] [nbt] | give preset [negs/stacked/spawners/bookban/eggs] [chest/shulker]";
	}
