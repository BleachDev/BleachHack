...
public class CustomChat extends Module {
	...
	public CustomChat() {
		super("CustomChat", KEY_UNBOUND, ModuleCategory.MISC, "Customizes your chat messages, use the " + Command.getPrefix() + "customchat command to edit the stuff.",
				...
				new SettingToggle("Prefix", false).withDesc("Message prepended to the message, set with " + Command.getPrefix() + "customchat prefix <message>"),
				new SettingToggle("Suffix", false).withDesc("Message appended to the message, set with " + Command.getPrefix() + "customchat suffix <message>"),
