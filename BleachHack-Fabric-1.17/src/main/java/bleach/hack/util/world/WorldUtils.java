...
public class WorldUtils {
	...
	public static boolean interactItem(BlockPos pos, int slot, SettingRotate sr, boolean forceLegit, boolean airPlace, boolean swingHand) {
		return interactItem(pos, slot, !sr.state ? 0 : sr.getRotateMode() + 1, forceLegit, airPlace, swingHand);
	}

	public static boolean interactItem(BlockPos pos, int slot, int rotateMode, boolean forceLegit, boolean airPlace, boolean swingHand) {
		if (!mc.world.isInBuildLimit(pos) || !isBlockEmpty(pos))
			return false;
