...
public class WorldRenderUtils {
	 ...
	 */
	public static MatrixStack drawText_NEW(String str, double x, double y, double z, double scale) {
	 ...
	 * @return The used MatrixStack for further use
	 */
	public static MatrixStack drawGuiItem_NEW(double x, double y, double z, double offX, double offY, double scale, ItemStack item) {
		MatrixStack matrix = matrixFrom(x, y, z);
